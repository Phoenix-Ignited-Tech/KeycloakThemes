...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="${resourceUrl}/assets/index-C1LIsRX7.js"></script>
    <link rel="stylesheet" crossorigin href="${resourceUrl}/assets/index-CE91Uf3U.css">
